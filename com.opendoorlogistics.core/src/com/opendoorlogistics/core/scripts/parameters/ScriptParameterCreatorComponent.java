...
import com.opendoorlogistics.api.scripts.parameters.Parameters.FieldType;
	...
	public void registerScriptTemplates(ScriptTemplatesBuilder templatesApi) {
		templatesApi.registerTemplate("Script parameter", "Script parameter", "Define a script parameter, accessible in the script using the sp(name) function.", new ScriptParameterCreatorComponent().getIODsDefinition(templatesApi.getApi(), null), new BuildScriptCallback() {
			...
			public void buildScript(ScriptOption builder) {
				...
				newParameter.setFormula(ParametersImpl.COL_KEY, "\"name\"");
				newParameter.setFormula(ParametersImpl.COL_VALUE_TYPE, "\"" + ODLColumnType.STRING.name()+ "\"");
				newParameter.setFormula(ParametersImpl.COL_DEFAULT_VALUE, "");
				newParameter.setFormula(ParametersImpl.COL_EDITOR_TYPE, "");
				newParameter.setFormula(ParametersImpl.COL_PROMPT_TYPE, "");
