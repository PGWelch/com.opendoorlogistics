...
import com.opendoorlogistics.core.formulae.Functions.FmRegExpMatchedText;
...
public final class FunctionDefinitionLibrary {
	...
	public FunctionDefinitionLibrary build() {
		...
		addStandardFunction(FmPostcodeUKFormatUnit.class, "postcodeUKUnitFormat", "Format a UK unit postcode, ensuring a single space between the two parts.", "raw_postcode");
