...
public final class FmLatitude extends Fm1GeometryParam {

	public FmLatitude(Function geometry) {
		super(geometry);
	}

	@Override
	public Function deepCopy() {
		return new FmLatitude(child(0).deepCopy());
	}

	@Override
	protected Object execute(Geometry geometry) {
		com.vividsolutions.jts.geom.Point pnt = geometry.getCentroid();
		return pnt.getCoordinate().y;
	}

	@Override
	public String toString() {
		return toString("latitude");
	}
}