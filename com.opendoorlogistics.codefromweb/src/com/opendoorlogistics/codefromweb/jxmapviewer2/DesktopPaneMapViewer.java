 ...
 * JDesktopPane instead of JPanel. This code is subject to the original
 * copyrights of the JxMapViewer2 project. Other modifications have also been
 * made.
 * 
 * The original JxMapViewer javadoc header follows:
 * 
 ...
 */
public class DesktopPaneMapViewer extends JDesktopPane implements DesignMode {
	 ...
	 */
	private Painter<? super DesktopPaneMapViewer> overlay;
	 ...
	 */
	public void setOverlayPainter(Painter<? super DesktopPaneMapViewer> overlay) {
		Painter<? super DesktopPaneMapViewer> old = getOverlayPainter();
	 ...
	 */
	public Painter<? super DesktopPaneMapViewer> getOverlayPainter() {
		return overlay;
	}
	...
	private TileListener tileLoadListener = new TileListener() {
		...
		public void tileLoaded(Tile tile) {
			if (tile.getZoom() == getZoom()) {
				repaint();
				/*
				 * this optimization doesn't save much and it doesn't work if
				 * you wrap around the world Rectangle viewportBounds =
				 * getViewportBounds(); TilePoint tilePoint = t.getLocation();
				 * Point point = new Point(tilePoint.getX() *
				 ...
				 * (viewportBounds.intersects(tileRect)) { //convert tileRect
				 * from world space to viewport space repaint(new Rectangle(
				 * tileRect.x - viewportBounds.x, tileRect.y - viewportBounds.y,
	 ...
	 * @author joshy
	 */
	public class DesktopPanePanMouseInputListener extends MouseInputAdapter {
		private Point prev;
	 ...
	 */
	public class DesktopPaneZoomMouseWheelListenerCursor implements MouseWheelListener {
